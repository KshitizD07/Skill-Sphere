...
export default function AuthPage() {
  ...
  const handleOAuthRedirect = (provider) => {
    ...
    const targetUrl = provider === 'google' ? googleUrl : githubUrl;
      ...
      <div className={panelBase}>
        ...
        <div className="space-y-3">
          <button
            ...
            className="flex items-center justify-center gap-3 w-full py-3 px-4 bg-surface-high border border-outline-var/40 hover:border-[#d97706]/50 rounded-xs text-sm font-syne font-bold text-text-primary transition-all shadow-sm hover:shadow-[#d97706]/10 cursor-pointer disabled:opacity-60"
          >
            ...
            {redirectingProvider === 'google' ? 'Redirecting to Google...' : 'Continue with Google'}
          </button>
          <button
            type="button"
            disabled={!!redirectingProvider}
          ...
          >
            ...
            {redirectingProvider === 'github' ? 'Redirecting to GitHub...' : 'Continue with GitHub'}
          </button>
        </div>
